...
/**
 * Represents an ASN.1 NULL Type.  Used to represent a placeholder for message for future use in
 * J2735 (2024), or as the value of CHOICE items in some specifications.
 */
