...
import j2735.CooperativeControlMessage.CCMPartIIcontent;
...
@JsonSubTypes({@JsonSubTypes.Type(value = j2735.Common.VehicleSafetyExtensionsCCMpartIIExtension.class, name = "0"),
		@JsonSubTypes.Type(value = j2735.CooperativeControlMessage.LightVehicleCCMExtensionsCCMpartIIExtension.class, name = "1"),
		@JsonSubTypes.Type(value = j2735.CooperativeControlMessage.HeavyTruckCCMExtensionsCCMpartIIExtension.class, name = "2")})
@Asn1ParameterizedTypes(idProperty = "partII_Id", idType = IdType.INTEGER, valueProperty = "partII_Value", value = {
		...
		@Asn1ParameterizedTypes.Type(value = j2735.CooperativeControlMessage.LightVehicleCCMExtensionsCCMpartIIExtension.class, intId = 1),
		@Asn1ParameterizedTypes.Type(value = j2735.CooperativeControlMessage.HeavyTruckCCMExtensionsCCMpartIIExtension.class, intId = 2)})
