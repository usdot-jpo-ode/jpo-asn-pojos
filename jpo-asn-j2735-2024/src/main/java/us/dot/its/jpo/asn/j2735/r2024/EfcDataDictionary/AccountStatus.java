...
public class AccountStatus extends Asn1Integer {
  ...
  private static class NamedValues {
    ...
    public NamedValues() {
      ...
      mapBuilder.put("ok", 0L);
      mapBuilder.put("low", 1L);
      mapBuilder.put("empty", 2L);
      mapBuilder.put("negative", 3L);
  ...
  public static Optional<AccountStatus> named(String name) {
    return Optional.ofNullable(namedValues.nameMap.get(name)).map(AccountStatus::new);
  }
