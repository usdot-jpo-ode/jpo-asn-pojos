...
@JsonDeserialize(using = ActuatedInterval.ActuatedIntervalDeserializer.class)
public class ActuatedInterval extends Asn1Boolean {

  public static class ActuatedIntervalDeserializer extends BooleanDeserializer<ActuatedInterval> {
