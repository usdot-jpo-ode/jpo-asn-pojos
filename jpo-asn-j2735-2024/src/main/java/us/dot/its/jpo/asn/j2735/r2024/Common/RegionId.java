...
public class RegionId extends Asn1Integer {
  ...
  private static class NamedValues {
    ...
    public NamedValues() {
      ...
      mapBuilder.put("noRegion", 0L);
      mapBuilder.put("addGrpA", 1L);
      mapBuilder.put("addGrpB", 2L);
      mapBuilder.put("addGrpC", 3L);
      mapBuilder.put("addGrpD", 4L);
  ...
  public static Optional<RegionId> named(String name) {
    return Optional.ofNullable(namedValues.nameMap.get(name)).map(RegionId::new);
  }
