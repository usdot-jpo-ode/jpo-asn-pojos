...
public class FutureCharacteristics extends Asn1Integer {
  ...
  private static final Map<String, Long> nameValueMap =
      Map.ofEntries(new SimpleEntry<>("noEntry", 0L), new SimpleEntry<>("airSuspension", 1L));
  ...
  public static Optional<FutureCharacteristics> named(String name) {
    return Optional.ofNullable(nameValueMap.get(name)).map(FutureCharacteristics::new);
  }
