...
public class DetectionMode extends Asn1Integer {
  ...
  private static class NamedValues {
    ...
    public NamedValues() {
      ...
      mapBuilder.put("measured", 0L);
      mapBuilder.put("inferred", 1L);
      mapBuilder.put("lac", 2L);
  ...
  public static Optional<DetectionMode> named(String name) {
    return Optional.ofNullable(namedValues.nameMap.get(name)).map(DetectionMode::new);
  }
