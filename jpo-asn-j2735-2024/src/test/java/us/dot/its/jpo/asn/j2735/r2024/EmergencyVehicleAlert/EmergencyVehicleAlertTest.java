...
public class EmergencyVehicleAlertTest extends BaseSerializeTest<EmergencyVehicleAlert> {

  public EmergencyVehicleAlertTest() {
    super(EmergencyVehicleAlert.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/EmergencyVehicleAlert/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/EmergencyVehicleAlert/json");
  }
}
