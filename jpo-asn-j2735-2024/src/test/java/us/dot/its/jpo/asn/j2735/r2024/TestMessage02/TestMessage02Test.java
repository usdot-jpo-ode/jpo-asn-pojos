...
public class TestMessage02Test extends BaseSerializeTest<TestMessage02> {

  public TestMessage02Test() {
    super(TestMessage02.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage02/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage02/json");
  }
}
