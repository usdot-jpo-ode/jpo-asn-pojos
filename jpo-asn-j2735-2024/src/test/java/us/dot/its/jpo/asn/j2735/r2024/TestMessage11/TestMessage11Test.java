...
public class TestMessage11Test extends BaseSerializeTest<TestMessage11> {

  public TestMessage11Test() {
    super(TestMessage11.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage11/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage11/json");
  }
}
