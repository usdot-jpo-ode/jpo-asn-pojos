...
public class CommonSafetyRequestTest extends BaseSerializeTest<CommonSafetyRequest> {

  public CommonSafetyRequestTest() {
    super(CommonSafetyRequest.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/CommonSafetyRequest/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/CommonSafetyRequest/json");
  }
}
