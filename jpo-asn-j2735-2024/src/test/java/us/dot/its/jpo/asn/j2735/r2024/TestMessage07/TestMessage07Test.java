...
public class TestMessage07Test extends BaseSerializeTest<TestMessage07> {

  public TestMessage07Test() {
    super(TestMessage07.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage07/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage07/json");
  }
}
