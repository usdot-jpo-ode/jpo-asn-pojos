...
public class TestMessage10Test extends BaseSerializeTest<TestMessage10> {

  public TestMessage10Test() {
    super(TestMessage10.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage10/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage10/json");
  }
}
