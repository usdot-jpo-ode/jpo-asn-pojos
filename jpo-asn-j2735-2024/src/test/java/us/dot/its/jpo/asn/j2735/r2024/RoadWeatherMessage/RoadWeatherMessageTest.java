...
public class RoadWeatherMessageTest extends BaseSerializeTest<RoadWeatherMessage> {

  public RoadWeatherMessageTest() {
    super(RoadWeatherMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadWeatherMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadWeatherMessage/json");
  }
}
