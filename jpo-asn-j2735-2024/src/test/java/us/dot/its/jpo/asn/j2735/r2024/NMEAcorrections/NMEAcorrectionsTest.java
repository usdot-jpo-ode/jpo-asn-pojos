...
public class NMEAcorrectionsTest extends BaseSerializeTest<NMEAcorrections> {

  public NMEAcorrectionsTest() {
    super(NMEAcorrections.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/NMEAcorrections/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/NMEAcorrections/json");
  }
}
