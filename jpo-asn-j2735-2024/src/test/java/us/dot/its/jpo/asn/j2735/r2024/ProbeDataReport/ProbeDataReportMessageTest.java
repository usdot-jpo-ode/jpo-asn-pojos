...
public class ProbeDataReportMessageTest extends BaseSerializeTest<ProbeDataReportMessage> {

  public ProbeDataReportMessageTest() {
    super(ProbeDataReportMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeDataReport/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeDataReport/json");
  }
}
