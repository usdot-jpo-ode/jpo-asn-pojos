...
public class ProbeVehicleDataTest extends BaseSerializeTest<ProbeVehicleData> {

  public ProbeVehicleDataTest() {
    super(ProbeVehicleData.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeVehicleData/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeVehicleData/json");
  }
}
