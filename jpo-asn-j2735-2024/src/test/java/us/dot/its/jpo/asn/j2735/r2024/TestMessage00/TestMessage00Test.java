...
public class TestMessage00Test extends BaseSerializeTest<TestMessage00> {

  public TestMessage00Test() {
    super(TestMessage00.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage00/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage00/json");
  }
}
