...
public class ProbeDataConfigMessageTest extends BaseSerializeTest<ProbeDataConfigMessage> {

  public ProbeDataConfigMessageTest() {
    super(ProbeDataConfigMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeDataConfig/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeDataConfig/json");
  }
}
