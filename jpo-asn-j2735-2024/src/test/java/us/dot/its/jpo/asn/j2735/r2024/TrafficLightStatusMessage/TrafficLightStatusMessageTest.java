...
public class TrafficLightStatusMessageTest  extends BaseSerializeTest<TrafficLightStatusMessage> {

  public TrafficLightStatusMessageTest() {
    super(TrafficLightStatusMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TrafficLightStatusMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TrafficLightStatusMessage/json");
  }
}
