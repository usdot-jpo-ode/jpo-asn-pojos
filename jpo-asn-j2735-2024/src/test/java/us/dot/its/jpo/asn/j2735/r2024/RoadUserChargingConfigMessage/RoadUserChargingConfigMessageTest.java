...
public class RoadUserChargingConfigMessageTest extends
    BaseSerializeTest<RoadUserChargingConfigMessage> {

  public RoadUserChargingConfigMessageTest() {
    super(RoadUserChargingConfigMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadUserChargingConfigMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadUserChargingConfigMessage/json");
  }
}
