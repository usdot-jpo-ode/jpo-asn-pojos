...
@Slf4j
public class SignalControlAndPrioritizationStatusMessageFrameTest
  extends BaseSerializeTest<SignalControlAndPrioritizationStatusMessageFrame> {

  public SignalControlAndPrioritizationStatusMessageFrameTest() {
    super(SignalControlAndPrioritizationStatusMessageFrame.class);
  }

  @Test
  public void canRoundTripXml() throws IOException {
    SignalControlAndPrioritizationStatusMessageFrame msg = fromXml(XER);
  ...
  public void canRoundTripJson() throws IOException {
    SignalControlAndPrioritizationStatusMessageFrame msg = fromJson(JER);
    assertThat(msg, notNullValue());
  ...
  final static String XER = """
      <MessageFrame>
        <messageId>47</messageId>
        <value>
          <SignalControlAndPrioritizationStatus></SignalControlAndPrioritizationStatus>
        </value>
      </MessageFrame>
      """;
