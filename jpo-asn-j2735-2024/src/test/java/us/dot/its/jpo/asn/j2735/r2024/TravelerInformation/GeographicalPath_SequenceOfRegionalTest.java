...
/**
 * Unit tests for the GeographicalPath_SequenceOfRegional class.
 */
public class GeographicalPath_SequenceOfRegionalTest {
  
  @Test
  public void constructorTest() {
    var seqOfReg = new GeographicalPath.SequenceOfRegional();
    ...
    assertThat(seqOfReg.getItemClass(), equalTo(Reg_GeographicalPath.class));
  }
