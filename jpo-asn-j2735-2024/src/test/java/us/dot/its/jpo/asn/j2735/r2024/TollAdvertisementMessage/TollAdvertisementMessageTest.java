...
public class TollAdvertisementMessageTest extends BaseSerializeTest<TollAdvertisementMessage> {

  public TollAdvertisementMessageTest() {
    super(TollAdvertisementMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollAdvertisementMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollAdvertisementMessage/json");
  }
}
