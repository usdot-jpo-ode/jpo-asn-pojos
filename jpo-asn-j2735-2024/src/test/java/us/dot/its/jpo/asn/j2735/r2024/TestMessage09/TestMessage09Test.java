...
public class TestMessage09Test extends BaseSerializeTest<TestMessage09> {

  public TestMessage09Test() {
    super(TestMessage09.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage09/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage09/json");
  }
}
