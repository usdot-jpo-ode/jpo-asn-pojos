...
public class CooperativeControlMessageTest extends BaseSerializeTest<CooperativeControlMessage> {
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/CooperativeControlMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/CooperativeControlMessage/json");
  }
}
