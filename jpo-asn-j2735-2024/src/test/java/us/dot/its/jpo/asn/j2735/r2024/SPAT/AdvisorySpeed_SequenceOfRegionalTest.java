...
/**
 * Unit tests for the AdvisorySpeed_SequenceOfRegional class.
 */
public class AdvisorySpeed_SequenceOfRegionalTest {
  
  @Test
  public void constructorTest() {
    var seqOfReg = new AdvisorySpeed.SequenceOfRegional();
    ...
    assertThat(seqOfReg.getItemClass(), equalTo(Reg_AdvisorySpeed.class));
  }
