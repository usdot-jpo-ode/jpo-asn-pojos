...
public class RptTrafficMetricsTest extends BaseSerializeTest<RptTrafficMetrics> {

  public RptTrafficMetricsTest() {
    super(RptTrafficMetrics.class);
  }

  @ParameterizedTest
  @MethodSource("xmlValues")
  public void canRoundTripXml(final String xer) throws IOException {
    RptTrafficMetrics msg = fromXml(xer);
  ...
  public void canRoundTripJson(final String jer) throws IOException {
    RptTrafficMetrics msg = fromJson(jer);
    assertThat(msg, notNullValue());
  ...
  static String wrapXml(String name) {
    return String.format("<RptTrafficMetrics><%s></%s></RptTrafficMetrics>", name, name);
  }
