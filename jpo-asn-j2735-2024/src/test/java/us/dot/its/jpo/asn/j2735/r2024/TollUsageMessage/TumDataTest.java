...
public class TumDataTest extends BaseSerializeTest<TumData> {
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollUsageMessage/TumData/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollUsageMessage/TumData/json");
  }
}
