...
public class TestMessage01Test extends BaseSerializeTest<TestMessage01> {

  public TestMessage01Test() {
    super(TestMessage01.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage01/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage01/json");
  }
}
