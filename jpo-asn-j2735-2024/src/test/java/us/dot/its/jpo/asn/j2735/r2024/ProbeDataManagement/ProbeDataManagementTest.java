...
public class ProbeDataManagementTest extends BaseSerializeTest<ProbeDataManagement> {

  public ProbeDataManagementTest() {
    super(ProbeDataManagement.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeDataManagement/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/ProbeDataManagement/json");
  }
}
