...
public class TestMessage04Test extends BaseSerializeTest<TestMessage04> {

  public TestMessage04Test() {
    super(TestMessage04.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage04/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage04/json");
  }
}
