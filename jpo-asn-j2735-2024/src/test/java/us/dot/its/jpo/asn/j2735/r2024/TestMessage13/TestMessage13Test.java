...
public class TestMessage13Test extends BaseSerializeTest<TestMessage13> {

  public TestMessage13Test() {
    super(TestMessage13.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage13/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage13/json");
  }
}
