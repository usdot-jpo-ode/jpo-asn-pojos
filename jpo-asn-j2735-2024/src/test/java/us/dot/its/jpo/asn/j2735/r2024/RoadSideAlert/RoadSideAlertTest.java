...
public class RoadSideAlertTest extends BaseSerializeTest<RoadSideAlert> {

  public RoadSideAlertTest() {
    super(RoadSideAlert.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadSideAlert/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadSideAlert/json");
  }
