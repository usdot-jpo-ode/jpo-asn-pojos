...
public class RoadUserChargingReportMessageTest extends BaseSerializeTest<RoadUserChargingReportMessage> {
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadUserChargingReportMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/RoadUserChargingReportMessage/json");
  }
}
