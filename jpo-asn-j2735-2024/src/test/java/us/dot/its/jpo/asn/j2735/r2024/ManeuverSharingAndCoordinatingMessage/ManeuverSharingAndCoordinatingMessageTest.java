...
public class ManeuverSharingAndCoordinatingMessageTest
    extends BaseSerializeTest<ManeuverSharingAndCoordinatingMessage> {

  public ManeuverSharingAndCoordinatingMessageTest() {
    super(ManeuverSharingAndCoordinatingMessage.class);
  }
