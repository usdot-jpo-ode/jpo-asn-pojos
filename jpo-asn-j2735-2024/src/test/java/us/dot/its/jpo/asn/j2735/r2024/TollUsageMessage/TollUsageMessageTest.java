...
public class TollUsageMessageTest extends BaseSerializeTest<TollUsageMessage> {

  public TollUsageMessageTest() {
    super(TollUsageMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollUsageMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollUsageMessage/json");
  }
}
