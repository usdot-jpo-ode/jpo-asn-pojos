...
public class TestMessage14Test extends BaseSerializeTest<TestMessage14> {

  public TestMessage14Test() {
    super(TestMessage14.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage14/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TestMessage14/json");
  }
}
