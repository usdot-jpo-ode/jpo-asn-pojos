...
public class TollUsageAckMessageTest extends BaseSerializeTest<TollUsageAckMessage> {

  public TollUsageAckMessageTest() {
    super(TollUsageAckMessage.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollUsageAckMessage/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/TollUsageAckMessage/json");
  }
}
