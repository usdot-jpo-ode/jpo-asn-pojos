...
public class IntersectionCollisionTest extends BaseSerializeTest<IntersectionCollision> {

  public IntersectionCollisionTest() {
    super(IntersectionCollision.class);
  }
  ...
  private static Stream<Arguments> getXmlResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/IntersectionCollision/xml");
  }

  private static Stream<Arguments> getJsonResources() {
    return getResources("/us/dot/its/jpo/asn/j2735/r2024/IntersectionCollision/json");
  }
}
